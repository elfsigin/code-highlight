...
const menuThemeProps={
  ...
  const handleHighlight = () => {
    ...
    getHighlightedHtml(code, language, theme, customStyles,containerRef.current,customHighlight,false);
  };
  ...
  const handleEditText=()=>{
    getHighlightedHtml(code,'javascript',theme,{},containerRef.current,[],true)
